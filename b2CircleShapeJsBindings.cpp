...
extern "C"
{
	...
	__declspec(dllexport) void* b2CircleShape_CreateFixture(
		void* body,
		// Fixturedef
	...
	__declspec(dllexport) void* b2CircleShape_CreateParticleGroup(
		void* particleSystem,
		// ParticleGroupDef
	...
	__declspec(dllexport) double b2CircleShape_DestroyParticlesInShape(
		void* particleSystem,
		// circle
