...
extern "C"
{
  __declspec(dllexport) void* b2World_Create(double x, double y) {
...
__declspec(dllexport) void* b2World_CreateBody(
  ...
  def.type = (b2BodyType)(int)type;
  def.userData = userData;
  return ((b2World*)world)->CreateBody(&def);
}

__declspec(dllexport) void* b2World_CreateParticleSystem(
...
__declspec(dllexport) void b2World_Delete(void* world) {
  delete (b2World*)world;
}

__declspec(dllexport) void b2World_DestroyBody(void* world, void* body) {
  ((b2World*)world)->DestroyBody((b2Body*)body);
}

__declspec(dllexport) void b2World_DestroyJoint(void* world, void* joint) {
  ((b2World*)world)->DestroyJoint((b2Joint*)joint);
}

__declspec(dllexport) void b2World_DestroyParticleSystem(void* world, void* particleSystem) {
...
*/
__declspec(dllexport) void b2World_SetGravity(void* world, double x, double y) {
  ((b2World*)world)->SetGravity(b2Vec2(x, y));
}

__declspec(dllexport) void b2World_Step(void* world, float step, float vIterations, float pIterations) {
