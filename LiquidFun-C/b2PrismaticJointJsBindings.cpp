...
extern "C"
{
	...
	__declspec(dllexport) void b2PrismaticJoint_EnableLimit(void* joint, double flag) {
	  ((b2PrismaticJoint*)joint)->EnableLimit((bool)flag);
	}
	__declspec(dllexport) void b2PrismaticJoint_EnableMotor(void* joint, double flag)  {
	  ((b2PrismaticJoint*)joint)->EnableMotor((bool)flag);
	}
	__declspec(dllexport) double b2PrismaticJoint_GetJointTranslation(void* joint) {
	  return ((b2PrismaticJoint*)joint)->GetJointTranslation();
	}

	__declspec(dllexport) double b2PrismaticJoint_GetMotorSpeed(void* joint) {
	  return ((b2PrismaticJoint*)joint)->GetMotorSpeed();
	}
	__declspec(dllexport) double b2PrismaticJoint_GetMotorForce(void* joint, double hz) {
	  return ((b2PrismaticJoint*)joint)->GetMotorForce(hz);
	}
	__declspec(dllexport) double b2PrismaticJoint_IsLimitEnabled(void* joint) {
	  return ((b2PrismaticJoint*)joint)->IsLimitEnabled();
	}
	__declspec(dllexport) double b2PrismaticJoint_IsMotorEnabled(void* joint) {
	  return ((b2PrismaticJoint*)joint)->IsMotorEnabled();
	}
	__declspec(dllexport) void b2PrismaticJoint_SetMotorSpeed(void* joint, double speed) {
	  ((b2PrismaticJoint*)joint)->SetMotorSpeed(speed);
	}

	__declspec(dllexport) void* b2PrismaticJointDef_Create(
		void* world,
		// joint def
	...
	__declspec(dllexport) void* b2PrismaticJointDef_InitializeAndCreate(
		void* world,
