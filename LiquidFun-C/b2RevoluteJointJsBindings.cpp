...
extern "C"
{
	...
	__declspec(dllexport) void b2RevoluteJoint_EnableLimit(void* joint, double flag) {
	  ((b2RevoluteJoint*)joint)->EnableLimit(flag);
	}
	__declspec(dllexport) void b2RevoluteJoint_EnableMotor(void* joint, double flag) {
	  ((b2RevoluteJoint*)joint)->EnableMotor(flag);
	}
	__declspec(dllexport) double b2RevoluteJoint_GetJointAngle(void* joint) {
	  return ((b2RevoluteJoint*)joint)->GetJointAngle();
	}
	__declspec(dllexport) double b2RevoluteJoint_IsLimitEnabled(void* joint) {
	  return ((b2RevoluteJoint*)joint)->IsLimitEnabled();
	}
	__declspec(dllexport) double b2RevoluteJoint_IsMotorEnabled(void* joint) {
	  return ((b2RevoluteJoint*)joint)->IsMotorEnabled();
	}

	__declspec(dllexport) void* b2RevoluteJointDef_Create(
		void* world,
		//Joint def
	...
	__declspec(dllexport) void* b2RevoluteJointDef_InitializeAndCreate(
	...
	__declspec(dllexport) void b2RevoluteJoint_SetMotorSpeed(void* joint, double speed) {
